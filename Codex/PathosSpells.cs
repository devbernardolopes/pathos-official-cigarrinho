...
namespace Pathos
{
  public sealed class CodexSpells : CodexPage<ManifestSpells, SpellEditor, Spell>
  {
      ...
      : base(Codex.Manifest.Spells)
    {
      ...
      light = AddSpell(Schools.abjuration, "light", 1, null, Glyphs.light_spell, Z =>
      {
        ...
        (
          ...
          U =>
          {
            ...
            U.Apply.WhenSourceHasDiet(Diets.photoautotroph, A => A.WhenSourceBelowAppetite(Appetites.hungry, A => A.Nutrition(1.d10() + 10)));
          },
          P =>
          {
          ...
          T =>
          {
            T.SetCast().Strike(Strikes.flash, Dice.Zero);
          ...
          D =>
          {
            D.SetCast().Strike(Strikes.flash, Dice.Zero);
      ...
      absorption = AddSpell(Schools.conjuration, "absorption", 16, new Precept(Purpose.Buff), Glyphs.absorption_spell, Z =>
      {
        Z.Description = null;
        SetAdept(Z,
                  null,
                  ...
                  T =>
                  {
                    T.SetCast().FilterCoins(false).FilterStock(Stocks.potion).SetAssetIndividualised();
                    T.Apply.DevourAsset(Sanctities.Uncursed);
                  },
                  D =>
                  {
                    D.SetCast().FilterCoins(false).SetAssetIndividualised();
      ...
      protoplasmatic_hands = AddSpell(Schools.transmutation, "protoplasmatic hands", 20, new Precept(Purpose.Buff), Glyphs.protoplasmatic_hands_spell, Z =>
      {
        ...
        SetAdept(Z,
            U =>
            {
              U.SetCast().SetTargetSelf();
              U.Apply.WhenChance(Chance.OneIn3, A => A.ApplyTransient(Properties.protoplasmatic_hands, 1.d2() + 1.d2()));
            },
            P =>
            {
              P.SetCast().SetTargetSelf();
              P.Apply.WhenChance(Chance.OneIn3, A => A.ApplyTransient(Properties.protoplasmatic_hands, 2.d2() + 1.d2()));
            },
            S =>
            {
              S.SetCast().SetTargetSelf();
              S.Apply.ApplyTransient(Properties.protoplasmatic_hands, 2.d2() + 2.d2());
              S.Apply.WhenChance(Chance.OneIn100, A => A.GainTalent(Properties.protoplasmatic_hands));
            },
            E =>
            {
              E.SetCast().SetTargetSelf();
              E.Apply.ApplyTransient(Properties.protoplasmatic_hands, 3.d2() + 2.d2());
              E.Apply.WhenChance(Chance.OneIn80, A => A.GainTalent(Properties.protoplasmatic_hands));
            },
            M =>
            {
              M.SetCast().SetTargetSelf();
              M.Apply.ApplyTransient(Properties.protoplasmatic_hands, 3.d2() + 3.d2());
              M.Apply.WhenChance(Chance.OneIn60, A => A.GainTalent(Properties.protoplasmatic_hands));
            },
            C =>
            {
              C.SetCast().SetTargetSelf();
              C.Apply.ApplyTransient(Properties.protoplasmatic_hands, 4.d2() + 3.d2());
              C.Apply.WhenChance(Chance.OneIn40, A => A.GainTalent(Properties.protoplasmatic_hands));
            },
            T =>
            {
              T.SetCast().SetTargetSelf();
              T.Apply.ApplyTransient(Properties.protoplasmatic_hands, 4.d2() + 4.d2());
              T.Apply.WhenChance(Chance.OneIn20, A => A.GainTalent(Properties.protoplasmatic_hands));
            },
            D =>
            {
              D.SetCast().SetTargetSelf();
              D.Apply.ApplyTransient(Properties.protoplasmatic_hands, 5.d2() + 4.d2());
              D.Apply.WhenChance(Chance.OneIn10, A => A.GainTalent(Properties.protoplasmatic_hands));
            }
          );
      });
    ...
    public readonly Spell protoplasmatic_hands;
    public readonly Spell absorption;
  }
}