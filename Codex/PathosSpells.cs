...
namespace Pathos
{
    public sealed class CodexSpells : CodexPage<ManifestSpells, SpellEditor, Spell>
    {
          ...
          : base(Codex.Manifest.Spells)
        {
            ...
            void SetAdept(SpellEditor Spell, Action<AdeptEditor> Unskilled, Action<AdeptEditor> Proficient, Action<AdeptEditor> Specialist, Action<AdeptEditor> Expert, Action<AdeptEditor> Master, Action<AdeptEditor> Champion, Action<AdeptEditor> Transcendent = null, Action<AdeptEditor> Divine = null)
            {
                Divine?.Invoke(Spell.SetAdept(Qualifications.divine));
                Transcendent?.Invoke(Spell.SetAdept(Qualifications.transcendent));
          ...
          (
            ...
            clairvoyance_reading = AddSpell(Schools.divination, "clairvoyance reading", 6, null, Glyphs.clairvoyance_reading_spell, Z =>
            {
                Z.Description = null;
                SetAdept
                (
            ...
            D =>
            {
                D.Apply.Gather(Range.Sq5, true, false, false);
                //D.SetCast().Strike(Strikes.psychic, Dice.Zero).SetTargetSelf();
                //D.Apply.DevourAsset

                //D.SetCast().FilterCoins(false).FilterStock(Stocks.book, Stocks.scroll).SetAssetIndividualised();
                ////D.Apply.LearnSpell( // WhenTargetItem()

                ////D.Apply.With DevourAsset(Sanctities.Blessed);
                //D.Apply.ApplyTransient(Properties.clairvoyance, 15.d6());
            }
          );
            });
          ...
          (
           ...
           .SetTerminates();
            ...
            T =>
            {
                T.SetCast().Strike(Strikes.boost, Dice.Zero).SetTerminates();
                T.Apply.DetectAsset(Range.Sq0, Stocks.gem, Stocks.ring, Stocks.amulet, Stocks.wand, Stocks.book);
            },
            C =>
            {
                C.SetCast().Strike(Strikes.boost, Dice.Zero).SetTerminates();
                C.Apply.DetectAsset(Range.Sq0);
            }
          );
            });
          ...
          (
            ...
            blessing = AddSpell(Schools.clerical, "blessing", 12, null, Glyphs.blessing_spell, Z =>
            {
                Z.Description = null;
                SetAdept
                (
                    ...
                    U =>
                    {
                        U.SetCast().FilterCoins(false).FilterIdentified(true).FilterSanctity(new[] { Sanctities.Uncursed }).SetAssetIndividualised(true);
                        //U.Apply.WhenChance(Chance.OneIn8, A => A.WhenChance(Chance.OneIn2, A1 => A1.RemoveCurse(Dice.Fixed(1), true, Sanctities.Blessed), A2 => A2.RemoveCurse(Dice.Fixed(1), true, Sanctities.Cursed)), AA => AA.DestroyTargetAsset(Dice.One));
                        U.Apply.Sanctify(Item: null, Sanctities.Blessed);
                    },
                    P =>
                    {
                        P.SetCast().FilterCoins(false).FilterIdentified(true).FilterSanctity(new[] { Sanctities.Uncursed }).SetAssetIndividualised(true);
                        P.Apply.Sanctify(Item: null, Sanctities.Blessed);
                    },
                    S =>
                    {
                        S.SetCast().FilterCoins(false).FilterIdentified(true).FilterSanctity(new[] { Sanctities.Uncursed }).SetAssetIndividualised(false);
                        S.Apply.Sanctify(Item: null, Sanctities.Blessed);
                    },
                    E =>
                    {
                        E.SetCast().FilterCoins(false).FilterIdentified(true).FilterSanctity(new[] { Sanctities.Uncursed }).SetAssetIndividualised(false);
                        E.Apply.Sanctify(Item: null, Sanctities.Blessed);
                    },
                    M =>
                    {
                        M.SetCast().FilterCoins(false).FilterIdentified(true).FilterSanctity(new[] { Sanctities.Uncursed }).SetAssetIndividualised(false);
                        M.Apply.Sanctify(Item: null, Sanctities.Blessed);
                    },
                    C =>
                    {
                        C.SetCast().FilterCoins(false).FilterIdentified(true).FilterSanctity(new[] { Sanctities.Cursed, Sanctities.Uncursed }).SetAssetIndividualised(false);
                        C.Apply.Sanctify(Item: null, Sanctities.Blessed);
                    },
                    T =>
                    {
                        T.SetCast().FilterCoins(false).FilterIdentified(true).FilterSanctity(new[] { Sanctities.Cursed, Sanctities.Uncursed }).SetAssetIndividualised(false);
                        T.Apply.RemoveCurse(Dice.Fixed(1));
                        T.Apply.Sanctify(Item: null, Sanctities.Blessed);
                    },
                    D =>
                    {
                        D.SetCast().FilterCoins(false).FilterIdentified(true).FilterSanctity(new[] { Sanctities.Cursed, Sanctities.Uncursed }).SetAssetIndividualised(false);
                        D.Apply.RemoveCurse(Dice.Fixed(1));
                        D.Apply.Sanctify(Item: null, Sanctities.Blessed);
                    });
            });


            enchantment = AddSpell(Schools.clerical, "enchantment", 10, null, Glyphs.enchantment_spell, Z =>
            {
                Z.Description = null;
                SetAdept
                (
                    ...
                    U =>
                    {
                        U.SetCast().FilterCoins(false).FilterIdentified(true).FilterSanctity(new[] { Sanctities.Blessed }).SetAssetIndividualised(true);
                        U.Apply.WhenChance(Chance.OneIn12, A => A.EnchantUp(Dice.One));
                    },
                    P =>
                    {
                        P.SetCast().FilterCoins(false).FilterIdentified(true).FilterSanctity(new[] { Sanctities.Blessed }).SetAssetIndividualised(true);
                        P.Apply.WhenChance(Chance.OneIn9, A => A.EnchantUp(Dice.One));
                    },
                    S =>
                    {
                        S.SetCast().FilterCoins(false).FilterIdentified(true).FilterSanctity(new[] { Sanctities.Uncursed, Sanctities.Blessed }).SetAssetIndividualised(false);
                        S.Apply.WhenChance(Chance.OneIn5, A => A.EnchantUp(Dice.One));
                    },
                    E =>
                    {
                        E.SetCast().FilterCoins(false).FilterIdentified(true).FilterSanctity(new[] { Sanctities.Uncursed, Sanctities.Blessed }).SetAssetIndividualised(false);
                        E.Apply.WhenChance(Chance.OneIn2, A => A.EnchantUp(Dice.One));
                    },
                    M =>
                    {
                        M.SetCast().FilterCoins(false).FilterIdentified(true).FilterSanctity(new[] { Sanctities.Uncursed, Sanctities.Blessed }).SetAssetIndividualised(false);
                        M.Apply.EnchantUp(Dice.One);
                    },
                    C =>
                    {
                        C.SetCast().FilterCoins(false).FilterIdentified(true).SetAssetIndividualised(false);
                        C.Apply.EnchantUp(Dice.One);
                    },
                    T =>
                    {
                        T.SetCast().FilterCoins(false).FilterIdentified(true).SetAssetIndividualised(false);
                        T.Apply.EnchantUp(Dice.One);
                    },
                    D =>
                    {
                        D.SetCast().FilterCoins(false).FilterIdentified(true).SetAssetIndividualised(false);
                        D.Apply.EnchantUp(Dice.One);
                    });
            });
          ...
          (
            ...
            U =>
            {
                U.SetCast().Strike(Strikes.flash, Dice.Zero).SetTerminates();

                U.Apply.Light(false, Locality.Area);

                U.Apply.ApplyTransient(Properties.deafness, 1.d3() + 3);

                U.Apply.WhenTargetKind(Kinds.Extradimensional,
                    A => A.WhenChance(Chance.OneIn6,
                        A2 => A2.WhenTargetResistant(Elements.drain,
                            B => B.Malnutrition(Dice.Fixed(100)), B2 => B2.DrainLife(Elements.drain, 1.d4() + 4)),
                    A3 => A3.Diminish(Dice.Four, Modifier.Zero)
                    )
                );
            },
            P =>
            {
                P.SetCast().Strike(Strikes.flash, Dice.Zero).SetTerminates();
                P.Apply.Light(false, Locality.Area);

                P.Apply.WhenTargetKind(Kinds.Extradimensional,
                    A => A.WhenChance(Chance.OneIn10,
                        A2 => A2.WhenTargetResistant(Elements.drain,
                            B => B.Malnutrition(Dice.Fixed(150)), B2 => B2.DrainLife(Elements.drain, 1.d4() + 2)),
                    A3 => A3.Diminish(Dice.Two, Modifier.Zero)
                    )
                );
            },
            S =>
            {
                S.SetCast().Strike(Strikes.flash, Dice.Zero).SetTerminates();
                S.Apply.Light(false, Locality.Area);
                S.Apply.AreaTransient(Properties.fear, 4.d6(), Kinds.angel, Kinds.human);

                S.Apply.WhenTargetKind(Kinds.Extradimensional,
                    A => A.WhenChance(Chance.OneIn13,
                        A2 => A2.WhenTargetResistant(Elements.drain,
                            B => B.Malnutrition(Dice.Fixed(100)), B2 => B2.DrainLife(Elements.drain, 1.d4())),
                    A3 => A3.Diminish(Dice.One, Modifier.Zero)
                    )
                );
            },
            E =>
            {
                E.SetCast().Strike(Strikes.flash, Dice.Zero).SetTerminates();
                ...
                E.Apply.WhenTargetKind(Kinds.Extradimensional, A => A.WhenChance(Chance.OneIn2, A2 => A2.Malnutrition(Dice.Fixed(80))));
            },
            M =>
            {
                M.SetCast().Strike(Strikes.flash, Dice.Zero).SetTerminates();
                ...
                M.Apply.WhenTargetKind(Kinds.Extradimensional, A => A.WhenChance(Chance.OneIn4, A2 => A2.Malnutrition(Dice.Fixed(60))));
            },
            C =>
            {
                C.SetCast().Strike(Strikes.flash, Dice.Zero).SetTerminates();
                ...
                C.Apply.WhenTargetKind(Kinds.Extradimensional, A => A.WhenChance(Chance.OneIn6, A2 => A2.Malnutrition(Dice.Fixed(40))));
            },
            T =>
            {
                T.SetCast().Strike(Strikes.flash, Dice.Zero).SetTerminates();
                T.Apply.Light(false, Locality.Area);
                T.Apply.AreaTransient(Properties.fear, 6.d6(), Kinds.Living.Union(Kinds.Undead).ToArray());
                T.Apply.AreaTransient(Properties.silence, 6.d6() + 6);

                T.Apply.WhenTargetKind(Kinds.Extradimensional, A => A.WhenChance(Chance.OneIn8, A2 => A2.Malnutrition(Dice.Fixed(20))));
            },
            D =>
            {
                D.SetCast().Strike(Strikes.flash, Dice.Zero).SetTerminates();
                D.Apply.Light(false, Locality.Area);
                D.Apply.AreaTransient(Properties.fear, 7.d6(), Kinds.Living.Union(Kinds.Undead).ToArray().Union(new[] { Kinds.giant, Kinds.dwarf, Kinds.dragon, Kinds.kobold, Kinds.bird, Kinds.bat, Kinds.elf }).ToArray());
                D.Apply.AreaTransient(Properties.silence, 7.d6() + 7);

                D.Apply.WhenTargetKind(Kinds.Extradimensional, A => A.WhenChance(Chance.OneIn12, A2 => A2.Malnutrition(Dice.Fixed(1))));
            }
          );
            });
          ...
          (
            ...
            U =>
            {
                U.SetCast().Strike(Strikes.flash, Dice.Zero).SetTerminates().SetTargetSelf();
                U.Apply.Light(true, Locality.Area);
                U.Apply.ApplyTransient(Properties.blindness, 1.d3() + 3);
                U.Apply.WhenTargetKind(Kinds.Extradimensional, A => A.WhenSourceBelowAppetite(Appetites.hungry, A => A.Nutrition(Dice.Fixed(20))));
            },
            P =>
            {
                P.SetCast().Strike(Strikes.flash, Dice.Zero).SetTerminates().SetTargetSelf();
                P.Apply.Light(true, Locality.Area);
                P.Apply.WhenTargetKind(Kinds.Extradimensional, A => A.WhenSourceBelowAppetite(Appetites.hungry, A => A.Nutrition(Dice.Fixed(30))));
            },
            S =>
            {
                S.SetCast().Strike(Strikes.flash, Dice.Zero).SetTerminates().SetTargetSelf();
                S.Apply.Light(true, Locality.Area);
                S.Apply.AreaTransient(Properties.fear, 4.d6(), Kinds.demon, Kinds.vampire, Kinds.orc);
                S.Apply.WhenTargetKind(Kinds.Extradimensional, A => A.WhenSourceBelowAppetite(Appetites.hungry, A => A.Nutrition(Dice.Fixed(40))));
            },
            E =>
            {
                E.SetCast().Strike(Strikes.flash, Dice.Zero).SetTerminates().SetTargetSelf();
                ...
                E.Apply.WhenTargetKind(Kinds.Extradimensional, A => A.WhenSourceBelowAppetite(Appetites.hungry, A => A.Nutrition(Dice.Fixed(50))));
            },
            M =>
            {
                M.SetCast().Strike(Strikes.flash, Dice.Zero).SetTerminates().SetTargetSelf();
                ...
                M.Apply.WhenTargetKind(Kinds.Extradimensional, A => A.WhenSourceBelowAppetite(Appetites.content, A => A.Nutrition(Dice.Fixed(60))));
            },
            C =>
            {
                C.SetCast().Strike(Strikes.flash, Dice.Zero).SetTerminates().SetTargetSelf();
                ...
                C.Apply.WhenTargetKind(Kinds.Extradimensional, A => A.WhenSourceBelowAppetite(Appetites.content, A => A.Nutrition(Dice.Fixed(70))));
            },
            T =>
            {
                T.SetCast().Strike(Strikes.flash, Dice.Zero).SetTerminates().SetTargetSelf();
                T.Apply.Light(true, Locality.Area);
                ...
                T.Apply.Repel(Range.Sq10, false, true, false);
                T.Apply.WhenTargetKind(Kinds.Extradimensional, A => A.WhenSourceBelowAppetite(Appetites.content, A => A.Nutrition(Dice.Fixed(80))));
                T.Apply.WhenTargetKind(Kinds.Extradimensional, A => A.ApplyTransient(Properties.life_regeneration, 2.d5() + 5));
            },
            D =>
            {
                D.SetCast().Strike(Strikes.flash, Dice.Zero).SetReflects(true).SetBounces(true).SetPenetrates(true).SetTargetSelf(false);
                //D.SetCast().Plain(Dice.Zero); // Beam(Beams. //Strike(Strikes.flash, Dice.Zero).SetReflects(false).SetBounces(false).SetPenetrates(false).SetTargetSelf(false);
                D.Apply.Light(true, Locality.Map);
                ...
                D.Apply.AreaTransient(Properties.photosensitivity, Dice.Three);
                //D.Apply.Harm(Elements.light, 10.d6());
                D.Apply.Repel(Range.Sq15, false, true, false);
                D.Apply.WhenTargetKind(Kinds.Extradimensional, A => A.WhenSourceBelowAppetite(Appetites.content, A => A.Nutrition(Dice.Fixed(90))));
                D.Apply.WhenTargetKind(Kinds.Extradimensional, A => A.ApplyTransient(Properties.life_regeneration, 3.d5() + 5));
                D.Apply.WhenTargetKind(Kinds.Extradimensional, A => A.ApplyTransient(Properties.slow_digestion, 5.d5() + 15));
                //D.Apply.UnlessTargetResistant(Elements. UnlessTargetHasProperty()

                //D.SetCast().Beam(Beams.lightning, Dice.Zero).SetBounces(true).SetReflects(true).SetTargetSelf(false);
                //D.Apply.Harm(Elements.magical, 5.d6());
            }
          );
            });
          ...
          (
           ...
           .SetTerminates();
            ...
            {
                T.SetCast().Strike(Strikes.boost, Dice.Zero).SetTerminates();
                T.Apply.Mapping(Range.Sq50, Chance.Always);
            },
            D =>
            {
                D.SetCast().Strike(Strikes.boost, Dice.Zero).SetTerminates();
                D.Apply.Mapping(Range.Sq0, Chance.Always);
                D.Apply.DetectBoulder(Range.Sq0);
                D.Apply.DetectTrap(Range.Sq0, Reveal: true);
            }
          );
            });
          ...
          (
           ...
           .SetObjects();
            ...
            replication = AddSpell(Schools.transmutation, "replication", 16, new Precept(Purpose.Buff), Glyphs.replication_spell, Z =>
            {
                Z.Description = null;
                SetAdept(Z,
                    null,
                    //U =>
                    //{
                    //    U.SetCast().Strike(Strikes.spirit, Dice.Zero).SetObjects(false);
                    //    U.Apply.WhenChance(Chance.OneIn9,
                    //        A => A.CreateAsset(Dice.One, null, Items.scroll_of_replication),
                    //            A2 => A2.WhenChance(Chance.OneIn4,
                    //                A21 => A21.DestroyOwnedAsset(3.d6(), null, null, new[] { Materials.gold })));
                    //},
                    P =>
                    {
                        P.SetCast().Strike(Strikes.spirit, Dice.Zero).SetObjects(false);
                        P.Apply.WhenChance(Chance.OneIn6,
                            A => A.CreateAsset(Dice.One, null, Items.scroll_of_replication),
                                A2 => A2.WhenChance(Chance.OneIn8,
                                    A21 => A21.DestroyOwnedAsset(10.d4(), null, null, new[] { Materials.gold })));
                    },
                    null,
                    //S =>
                    //{
                    //    S.SetCast().Strike(Strikes.spirit, Dice.Zero).SetObjects(false);
                    //    S.Apply.WhenChance(Chance.OneIn3,
                    //        A => A.CreateAsset(Dice.One, 1.d2(), Items.scroll_of_replication),
                    //            A2 => A2.WhenChance(Chance.OneIn16,
                    //                A21 => A21.DestroyOwnedAsset(1.d2(), null, null, new[] { Materials.gold })));
                    //},
                    E =>
                    {
                        E.SetCast().Strike(Strikes.spirit, Dice.Zero).SetObjects(false);
                        E.Apply.WhenChance(Chance.OneIn2,
                            A => A.CreateAsset(Dice.One, 1.d2(), Items.scroll_of_replication));
                    },
                    M =>
                    {
                        M.SetCast().Strike(Strikes.spirit, Dice.Zero).SetObjects(false);
                        M.Apply.CreateAsset(Dice.One, 1.d2(), Items.scroll_of_replication);
                    },
                    C =>
                    {
                        C.SetCast().Strike(Strikes.spirit, Dice.Zero).SetObjects(false);
                        C.Apply.CreateAsset(Dice.Two, 1.d2(), Items.scroll_of_replication);
                    },
                    T =>
                    {
                        T.SetCast().FilterCoins(false).SetAssetIndividualised();
                        T.Apply.ReplicateAsset();
                    },
                    D =>
                    {
                        D.SetCast().FilterCoins(false).SetAssetIndividualised();
                        D.Apply.ReplicateAsset();
                    }
                  );
            });
           ...
           .SetObjects();
            ...
            teleport_up = AddSpell(Schools.abjuration, "teleport up", 10, new Precept(Purpose.Teleport), Glyphs.teleport_up_spell, Z =>
            {
                ...
                SetAdept(Z,
                    ...
                    {
                        C.SetCast().Strike(Strikes.flash, Dice.Zero).SetTerminates();
                        C.Apply.TransitionAscend(Teleport: null, Dice.Fixed(1));
                    }
                );
            });
            ...
            teleport_down = AddSpell(Schools.abjuration, "teleport down", 10, new Precept(Purpose.Teleport), Glyphs.teleport_down_spell, Z =>
            {
                ...
                SetAdept(Z,
                    ...
                    {
                        C.SetCast().Strike(Strikes.flash, Dice.Zero).SetTerminates();
                        C.Apply.TransitionDescend(Teleport: null, Dice.Fixed(1));
                    }
                );
            });
        ...
        public readonly Spell teleport_up;
        public readonly Spell teleport_down;
        ...
        public readonly Spell enchantment;
        public readonly Spell blessing;
        ...
        public readonly Spell clairvoyance_reading;
        ...
        public readonly Spell replication;
    }
}