  ...
  public sealed class CodexMotions : CodexPage<ManifestMotions, MotionEditor, Motion>
  {
      ...
      : base(Codex.Manifest.Motions)
    {
      ...
      Motion AddMotion(
        string PresentName,
        string PastName,
        Attribute InfluencingAttribute,
        Action<MotionEditor> EditorAction,
        bool? UseVisionBypassedByProperty = null,
        Property UseVisionBypassProperty = null,
        bool? UseVoiceBypassedByProperty = null,
        Property UseVoiceBypassProperty = null,
        bool? UseConcentrationBypassedByProperty = null,
        Property UseConcentrationBypassProperty = null
        )
      {
        return Register.Add(M =>
        {
          ...
          M.UseVisionBypassedByProperty = UseVisionBypassedByProperty;
          M.UseVisionBypassProperty = UseVisionBypassProperty;
          M.UseVoiceBypassedByProperty = UseVoiceBypassedByProperty;
          M.UseVoiceBypassProperty = UseVoiceBypassProperty;
          M.UseConcentrationBypassedByProperty = UseConcentrationBypassedByProperty;
          M.UseConcentrationBypassProperty = UseConcentrationBypassProperty;
      ...
      }, true, Properties.clairvoyance, null, null, null, null);

      clairvoir = AddMotion("clairvoir", "clairvu", Attributes.intelligence, M =>
      {
        M.UseVision = false;
        M.UseConcentration = true;
        M.PractisingSkill = Skills.literacy;
        M.UseAnatomy(Anatomies.mind);
      });
      ...
      refill = AddMotion("refill", "refilled", Attributes.wisdom, M =>
{
  M.UseAnatomy(Anatomies.hands);
    ...
    public readonly Motion clairvoir;
  }
}